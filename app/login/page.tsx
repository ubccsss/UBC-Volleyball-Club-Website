    ...
    <div className="container relative hidden h-[calc(100vh-65px)] flex-col items-center justify-center sm:grid lg:max-w-none lg:grid-cols-2 lg:px-0">
      <div className="relative hidden h-full flex-col bg-muted p-10 text-white dark:border-r lg:flex">
        <div className="absolute inset-0 bg-zinc-900">
          <img className="size-full object-cover" src="https://www.ubcvolleyball.club/uploads/6/9/6/2/69627653/background-images/1589257857.jpeg" alt="Login hero" />
      ...
      <div className="lg:p-8">
        <div className="mx-auto flex w-full flex-col justify-center space-y-6 sm:w-[350px]">
          ...
          <p className="px-8 text-center text-sm text-muted-foreground">
            Not registered? <a className="underline underline-offset-4 hover:text-primary" href="/signup">Sign up!</a>.
          </p>
        </div>
      </div>
    </div>
