...
export default function LoginPage() {
  ...
  async function onSubmit(values: z.infer<typeof formSchema>) {
    console.log(values)
    await signup(values as LoginData)
  }
      ...
      <div className="relative hidden h-full flex-col bg-muted p-10 text-white dark:border-r lg:flex">
        <div className="absolute inset-0 bg-zinc-900">
          <img
            ...
            src="https://www.ubcvolleyball.club/uploads/6/9/6/2/69627653/background-images/1589257857.jpeg"
            alt="Login hero"
          />
        ...
        <div className="relative z-20 mt-auto">
          <blockquote className="space-y-2">
            ...
            <footer className="text-lg">est. 2022</footer>
          </blockquote>
        </div>
      </div>
        ...
        <div className="mx-auto flex w-full flex-col justify-center space-y-6 sm:w-[350px]">
          <div className="flex flex-col space-y-2 text-center">
            <div className="mx-auto block w-6/12">
              <img
                src="https://www.ubcvolleyball.club/uploads/6/9/6/2/69627653/s105778333429576097_p6_i1_w1563.png?width=640"
          ...
          <div className="grid gap-6">
            ...
            {/* PUT GOOGLE LOG IN BUTTONS HERE AND OTHER LOGIN TYPES */}
            <button
